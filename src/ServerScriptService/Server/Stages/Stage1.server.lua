...
local carfolder = game:GetService("Workspace"):WaitForChild("Obstacles"):WaitForChild("Stage1")

local cfg = {
	Items = {
		item = "Part1",
		startPos = CFrame.new(53.388, 81.896, -354.594), --初始位置
		endPos = CFrame.new(-89.809, 81.896, -354.594), --结束位置
		startspeed = 2, --初始速度
		endSpeed = 2, --返回速度
		starttime = 2, --出发等待时间
		endtime = 0, --返回停留时间
	...
	{
		item = "Part2",
		startPos = CFrame.new(53.388, 81.896, -487.035), --初始位置
		endPos = CFrame.new(-89.809, 81.896, -487.035), --结束位置
		startspeed = 2,
		endSpeed = 2,
		starttime = 2,
		endtime = 0,
	...
	{
		item = "Part3",
		startPos = CFrame.new(53.388, 81.896, -614.19), --初始位置
		endPos = CFrame.new(-89.809, 81.896, -614.19), --结束位置
		startspeed = 2,
		endSpeed = 2,
		starttime = 2,
		endtime = 0,
