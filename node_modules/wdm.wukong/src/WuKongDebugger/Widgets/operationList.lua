return function(Plasma)
	...
	return Plasma.widget(function(items, custom, options)
		options = options or {}
		...
		for key, groupItem in items do
			local temp = custom.operationGroup(key, groupItem):selected()
			if not selected and temp then
				selected = {
					t = key,
					i = temp
				}
