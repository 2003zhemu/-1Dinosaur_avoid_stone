...
local function resetTypesCache()
  types ={
...
-- 热更新时,需要重载缓存
System.resetTypesCache = resetTypesCache
resetTypesCache()
...
if System.debugsetmetatable then
  ...
  is = function (obj, T)
    ...
    -- roblox service
    if obj ~=nil and type(obj)=="userdata" and obj.ClassName == T.__name__ then
      return true
    end
