...
#if __CSharpLua__
    public {{__name}}(object luaDatas)
    {
        _dataMap = new System.Collections.Generic.Dictionary<{{declaring_type_name __key_type}}, {{declaring_type_name __value_type}}>();
        _dataList = new System.Collections.Generic.List<{{declaring_type_name __value_type}}>();
        var dict = LuaTable.GetDict(luaDatas);
        foreach (var pair in dict)
        {
            var {{deserialize_field '_v' '_json' 'pair.Value' __value_type true}}
            this.DataList.Add(_v);
...
#else
    public {{__name}}(JsonElement _json)
    {
        _dataMap = new System.Collections.Generic.Dictionary<{{declaring_type_name __key_type}}, {{declaring_type_name __value_type}}>();
        _dataList = new System.Collections.Generic.List<{{declaring_type_name __value_type}}>();
        ...
        {
            var {{deserialize '_v' '_row' __value_type}}
            _dataList.Add(_v);
...
{{~end~}}
    ...
    public void AfterResolve(Tables _tables)
    {
        foreach(var v in _dataList)
        {
